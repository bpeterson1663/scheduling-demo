module.exports = {
  requestBodyInvalid: 'Request body is invalid for shift',
  shiftOvelapsError: 'Shift overlaps with an already existing shift',
  userUnathorized: 'User is unathorized to make this request',
